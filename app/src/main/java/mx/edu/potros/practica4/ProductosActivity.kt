...
class ProductosActivity : AppCompatActivity() {
    ...
    fun agregaProductos(option:String?){
        var imagenTitulo: ImageView = findViewById(R.id.imagen_titulo) as ImageView
        when(option){
            "antojitos"->{
                imagenTitulo.setImageResource(R.drawable.antojitos)
            ...
            "especialidades"->{
                imagenTitulo.setImageResource(R.drawable.especialidades)
            ...
            "combinations"->{
                imagenTitulo.setImageResource(R.drawable.combinations)
            ...
            "tortas"->{
                imagenTitulo.setImageResource(R.drawable.tortas)
            ...
            "sopas"->{
                imagenTitulo.setImageResource(R.drawable.sopas)
                ...
                menu.add(Product("Sopas de Mariscos", R.drawable.sopamariscos, "Seafood soup", 9.99))
                menu.add(Product("Coctel de Camaron", R.drawable.coctel, "Shrimp cocktail", 14.99))
            }
            "drinks"->{
                imagenTitulo.setImageResource(R.drawable.drinks)
                ...
                menu.add(Product("Lata Beer", R.drawable.mexicanbeer, "", 2.99))
                menu.add(Product("Charolazo", R.drawable.charolazo, "", 15.79))
                menu.add(Product("Charolazo con camarones", R.drawable.charolazo, "", 21.99))
                menu.add(Product("La mamalona", R.drawable.charolazo, "", 12.99))
                menu.add(Product("La mamalona con camarones", R.drawable.charolazo, "", 14.99))
